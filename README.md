...
| `driving_license_number` | `NoneType`/`str` | Номер водительского удостоверения<sup>1</sup> |
| `driving_license_issue_date` | `NoneType`/`str` | Дата выдачи водительского удостоверения<sup>1</sup> |

<sup>1</sup> Существование данных атрибутов обусловлено задачей идентификации.
