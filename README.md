...
1. Через несколько секунд начнётся обновление
...
| `service_type` | `str` | Тип счётчика<sup>*</sup> |
...
| `reason` | `str` | Причина ошибки _(атрибут отсутствует, если ошибок не было)_ |
